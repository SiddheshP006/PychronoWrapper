   ...
   # while vis.Run():
        ...
        if (time_now > controller_start_time): #0.1
            ...
            if controller_type == 'PID':
                ...
                #DATA_vector[2:5] = translational_position_in_I_user
                #DATA_vector[5:8] = translational_velocity_in_I_user
                #DATA_vector[8:11] = translational_acceleration_in_I_user
                #DATA_vector[11] = yaw_ref
                #DATA_vector[10] = yaw
